...
parse = argparse.ArgumentParser(description = "Simple example")
...
parse.add_argument('--Y', help = "define Y columns in data")
parse.add_argument('--X', nargs = '*', help = "define X columns in data")
