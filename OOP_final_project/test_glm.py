...
def tester(source, distribution):
    ...
    if source == "i":
        ...
        # Create an object that loads .csv data from the Internet
        ...
        # assign xvalues to X and yvalues to Y 
        # inputs for an object of subclass Poisson of GLM class        
        Y = iloader.yvalues
        X = iloader.xvalues
        print(f"\nExample of X values:\n",X.tail(),
            '\nExample of Y values:\n',Y.tail())
    ...
    if source == "r":
        ...
        # assign xvalues to X and yvalues to Y 
        # inputs for an object of subclass Normal of GLM class
        Y = rloader.yvalues
        X = rloader.xvalues
        print(f"\nExample of X values:\n",X.head(),
            '\nExample of Y values:\n',Y.head())
    ...
    if source == "sm":
        name = 'spector'
        # Create an object that loads data from a dataset inside statsmodels
        ...
        # assign xvalues to X and yvalues to Y
        # inputs for an object of subclass Bernoulli of GLM class
        Y = smloader.yvalues
        X = smloader.xvalues
        print(f"\nExample of X values:\n",X.head(),
            '\nExample of Y values:\n',Y.head())
...
### Example tester arguments: ('sm','bernoulli') - ('i','poisson') - ("r","normal")